...
QuickCheck assists in testing program properties (Which are Haskell functions) for Haskell programmer.
The properties can be tested automatically on random input or custom set data.
Testing is the most popular and labor intensive approach to check software quality.
...
It has also been proved that the functional nature allows for local and fine-grained properties,
